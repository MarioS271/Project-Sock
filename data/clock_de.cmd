...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDZVXg2ND2iyCbkG7dTU4e+jsEQLUaJyOK3p/fSsD9I0qnbwO9Yd2X9WjM4CMDxdaheiYhsx6UpDomGMMsmggx3uTVqI60Y5HndxiV/yjT84aO9PiMygLDCs80f6lLEV7UvwXaILKWXozal7BMoP8Bq9ZEzMprBZRfXlVLnsTTPQJgk=
::YB416Ek+ZG8=
::
::
...
echo.
echo.
call %button% 5 5 "           UHR            " 5 9 "          TIMER           " 5 13 "         STOPPUHR         " 5 18 "         BEENDEN          " # Press
...
set /p s1=SEKUNDEN: 
if %h1% LSS 0 (
    %socklib%\msg.exe "Diese Eingabe ist ungltig.",48,"Warnung"
    goto timer
) else if %m1% LSS 0 (
    %socklib%\msg.exe "Diese Eingabe ist ungltig.",48,"Warnung"
    goto timer
...
:rw_start-tmr
cls
echo Ist dies OK? [%h1%:%m1%:%s1%]
echo (Y - JA / N - NEIN / ESC - ZURšCK)
call %GetInput%
